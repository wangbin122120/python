...
from keras import pooling
from keras import local
from keras import recurrent
from keras import noise
from keras import normalization
from keras import advanced_activations
from keras import embeddings
...
readme = open('../README.md','r', encoding='UTF-8').read() #open('../README.md').read()
index = open('templates/index.md').read()
index = index.replace('{{autogenerated}}', readme[readme.find('##'):])
f = open('sources/index.md', 'w', encoding='UTF-8')
f.write(index)
f.close()
