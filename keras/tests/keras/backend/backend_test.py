...
from keras import cntk_backend as KC
from keras import convert_kernel
from keras import tensorflow_backend as KTF
from keras import theano_backend as KTH, floatx, set_floatx, variable
