...
from keras import Dense, Dropout, InputLayer
from keras import Input, get_source_inputs
from keras import Model, Sequential
from keras import backend as K
from keras import keras_test
from keras import layers
from keras import model_from_json, model_from_yaml
...
def test_load_layers():
    from keras import ConvLSTM2D, TimeDistributed, Bidirectional, Conv2D, Input
    from keras import Model
    from keras import preprocess_weights_for_loading
...
def test_shared_layer_depth_is_correct():
    ...
    from keras import Embedding, Input, Dense, Concatenate
    from keras import Model
