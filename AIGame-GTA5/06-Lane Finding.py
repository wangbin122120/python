...
def process_img_edge(original_image, threshold1=200, threshold2=300):
    ...
    lines = cv2.HoughLinesP(processed_img, 1, np.pi / 180, 180, minLineLength=50, maxLineGap=10)
...
def process_img(original_image, threshold1=200, threshold2=300):
    ...
    img_with_lanes = process_img_lane(original_image,edge_lines)
    return img_with_edge,img_with_lanes
...
def screen_record():
    ...
    while (True):
        ...
        img_with_edge, img_with_lanes = process_img(printscreen, threshold1=200, threshold2=200)
